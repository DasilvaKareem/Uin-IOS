...
class eventFeedViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        ...
        println(objectID[indexPath.row])
        ...
        minique.whereKey("eventID", equalTo: objectID[indexPath.row])
       // minique2.whereKey("eventID", matchesKey:objectID[indexPath.row] , inQuery:minique )
